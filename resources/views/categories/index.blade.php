        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active"><a href="{{route('categories.index')}}">Subject</a></li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              ...
              <a href="{{route('categories.create')}}" class="btn btn-success"  style="float: right;">Add Subject</a>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
           ...
           <tbody>
             @foreach($categories as $category)
                <tr>
                 ...
                 <button class="btn btn-danger btn-sm" onclick="handledelete({{ $category->id }})">Delete</button></td>
                </tr>
               @endforeach
                </tbody>
                <tfoot>
